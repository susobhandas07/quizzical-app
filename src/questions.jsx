...
export default function main(props) {
    let [questionObjects, setQuestionObjects] = React.useState(props.data);
    ...
    function checkAnswers(event) {
        ...
        storeAnswers = function (event, id) { };
        document.querySelector(':root').style.setProperty('--checked', 'transparent');
    }
